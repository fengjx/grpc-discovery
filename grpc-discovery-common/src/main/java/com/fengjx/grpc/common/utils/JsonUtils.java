...
public class JsonUtils {
     ...
     * 默认json格式化方式
     */
    private static final SerializerFeature[] DEFAULT_FORMAT = { SerializerFeature.WriteDateUseDateFormat,
    ...
    /**
     * 将传入的json字符串转换成Map，保留json的key顺序不变
     *
     * @param jsonString
     * @return
     */
    @SuppressWarnings("unchecked")
    public static Map<String, Object> toOrderedMap(String jsonString) {
        Validate.notNull(jsonString, "jsonString is null");
        return JSON.parseObject(jsonString, Map.class, Feature.OrderedField);
    }
